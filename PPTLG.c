/*Jogo "Pedra Papel Tesoura Lagarto Spock" contra a máquina. 
Feito em linguagem C por Mateus C. Cardoso.
Baseado no jogo original "Rock Paper Scissors Spock Lizard", de Sam Kass e Karen Bryla.
*/
#include<stdio.h>
#include<locale.h>
int main(){
